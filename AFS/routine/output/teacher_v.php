...
$sql="select teacher_id from teacher where email='$t_email'";
...
//     $result=mysqli_query($connect, $query);
  ...
  //       }
	...
	if ($teacher_id=='SNK')
	{$t_name='Dr. Shamsun Naher Khanom';}
	elseif($teacher_id=='ZK')
	{$t_name="Zurana Aziz";}
	
	elseif($teacher_id=='RAH')
	{$t_name="Dr.Rokhsan-Ara-Hemel";}
	elseif($teacher_id=='SG')
	{$t_name="Sumona Gupta";}
	
	elseif($teacher_id=='MR')
	{$t_name="Dr.Maksudur Rahman";}
	elseif($teacher_id=='NN')
	{$t_name="Nurjahan Nipa";}
	
	elseif($teacher_id=='SH')
	{$t_name="Sabbir Hossain";}
	
	elseif($teacher_id=='MA')
	{$t_name="Munira Akter Lata";}
	
    
    
    
    elseif($teacher_id=='AZ')
	{$t_name="Md. Ashrafuzzaman";}
	
	elseif($teacher_id=='MAK')
	{$t_name="Dr. Md. Aktaruzzaman";}
	elseif($teacher_id=='SR')
	{$t_name="Dr. Md. Sazzadur Rahman";}
	
	elseif($teacher_id=='ZN')
	{$t_name="Syeda Zakia Nayem";}
	elseif($teacher_id=='FI')
	{$t_name="Farhana Islam";}
	
	elseif($teacher_id=='HR')
	{$t_name="Habibir Rahman";}
	
	elseif($teacher_id=='FA')
	{$t_name="Farzana Akter";}
    
    
    
    
    elseif($teacher_id=='SA')
	{$t_name="Dr Sabbir Alam";}
	elseif($teacher_id=='SR')
	{$t_name="Dr. Md. Sazzadur Rahman";}
	
	elseif($teacher_id=='MMR')
	{$t_name="Mohammad Mamun Or Rashid";}
	
	elseif($teacher_id=='MAR')
	{$t_name="Dr. Mohammad Mahbubur Rahman";}
  ...
  ?>
			...
			<div class="col-sm-3">
				<h3><span>Routine for Teacher: <font color="4590C8"><?php echo $t_name ."&nbsp &nbsp";?></font></span></h3>
			</div>
       ...
       while ( $row = mysqli_fetch_array($result1))
        {
          ...
          ?>
            ...
            <?php
                      ...
                      $room_No216 = " ";
					  $lab_208='';
              $query="SELECT id,sub_code,'iot_1st' as semester ,room_no,day,ctime,lab FROM $semester11 
