<?php
		...
		if($_GET['pdf']= 'yes' ){
											...
											$html=file_get_contents("http://localhost/RMS/Admin/output/teacher_pdf.php?");
...
<body >
  ...
  <a href="http://localhost/MIS/admin/teacher_pdf.php?type=1&&meetingId=1&&secondTypeID=&pdf=yes">PRINT PDF</a>
