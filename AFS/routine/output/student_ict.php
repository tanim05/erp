...
//     $result=mysqli_query($connect, $query);
  ...
  //       }
	...
	?>
			...
			<div class="col-sm-3">
				<h3 align='center'> <b><font color='3583B0'>Routine For <span>ICTE 1st Semester</span></b></font></h3>
			</div>
       ...
       while ( $row = mysqli_fetch_array($result1))
        {
            ...
            elseif ($row['ctime']=='16:00-17:00') {
              ...
              <th bgcolor="#909497" scope="col"><?php //echo "<h5 align='center'"."<br>".$sub_code210."<br> ".$teacher_id210."<br> ".$room_No210; ?></th>  <?php }   
			      ...
			      <th  bgcolor="#FAF1F1"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code111."<br> ".$teacher_id111."<br> ".$room_No111."</h5>"; ?></th>
			  	  ...
			  	  <?php if($sub_code115==$sub_code116){ ?>   
				  
              
						  <th bgcolor="#FAF1F1"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code115."<br> ".$teacher_id115."<br> ".$room_No115; ?></th>
						  <th bgcolor="#FAF1F1"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code116."<br> ".$teacher_id116."<br> ".$room_No116; ?></th><?php }   
            ...
            ?>
			  ...
			  <?php if($sub_code510==$sub_code511){ ?>   
				  
              <th  bgcolor="#6198C6"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code510."<br> ".$teacher_id510."<br> ".$room_No510; ?></th>
              <th  bgcolor="#6198C6"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code511."<br> ".$teacher_id511."<br> ".$room_No511; ?></th> <?php }   
			  
			  else{ ?>
              	  
              <th  bgcolor="#FAF1F1"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code510."<br> ".$teacher_id510."<br> ".$room_No510; ?></th>
              <th  bgcolor="#FAF1F1"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code511."<br> ".$teacher_id511."<br> ".$room_No511; ?></th><?php }   ?>
              ...
              <th  bgcolor="#6198C6"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code515."<br> ".$teacher_id515."<br> ".$room_No515; ?></th>
              <th bgcolor="#6198C6" scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code516."<br> ".$teacher_id516."<br> ".$room_No516; ?></th>  <?php }   ?>
