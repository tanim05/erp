...
//     $result=mysqli_query($connect, $query);
  ...
  //       }
	...
	?>
			...
			<div class="col-sm-3">
				<h3 align='center'>Routine For <span>IOT 1st Semester</span></h3>
			</div>
       ...
       while ( $row = mysqli_fetch_array($result1))
        {
            ...
            elseif ($row['ctime']=='16:00-17:00') {
              ...
              $room_No116 = 'Room-'.$row['room_no'];
				  ...
				  ?>
					  	  ...
					  	  <?php if ($lab_108=='l') {?>	
			   <th  bgcolor="#BAAFAF"scope="col"><?php// echo "<h5 align='center'"."<br>".$sub_code208."<br> ".$teacher_id208."<br> ".$room_No208; ?></th>
              <th  bgcolor="#BAAFAF"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code109."<br> ".$teacher_id109."<br> ".$room_No109; ?></th>
              <th bgcolor="#BAAFAF" scope="col"><?php //echo "<h5 align='center'"."<br>".$sub_code210."<br> ".$teacher_id210."<br> ".$room_No210; ?></th>  <?php }   
              ...
              <th bgcolor="#FAF1F1" scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code110."<br> ".$teacher_id110."<br> ".$room_No110; ?></th>  <?php }   ?>
				      ...
				      <th  bgcolor="#FAF1F1"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code113."<br> ".$teacher_id113."<br> ".$room_No113."</h5>"; ?></th>
				      ...
				      <th  bgcolor="#FAF1F1"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code116."<br> ".$teacher_id116."<br> ".$room_No116."</h5>"; ?></th>
				    </tr>
				    <tr>
            ...
            ?>
			   ...
			   <?php if ($lab_209=='l') {?>	
			   <th  bgcolor="#BAAFAF"scope="col"><?php// echo "<h5 align='center'"."<br>".$sub_code208."<br> ".$teacher_id208."<br> ".$room_No208; ?></th>
              <th  bgcolor="#BAAFAF"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code209."<br> ".$teacher_id209."<br> ".$room_No209; ?></th>
              <th bgcolor="#BAAFAF" scope="col"><?php //echo "<h5 align='center'"."<br>".$sub_code210."<br> ".$teacher_id210."<br> ".$room_No210; ?></th>  <?php }   
            ...
            ?>
			  ...
			  <?php if ($lab_309=='l') {?>	
			   <th  bgcolor="#BAAFAF"scope="col"><?php// echo "<h5 align='center'"."<br>".$sub_code208."<br> ".$teacher_id208."<br> ".$room_No208; ?></th>
              <th  bgcolor="#BAAFAF"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code309."<br> ".$teacher_id309."<br> ".$room_No309; ?></th>
              <th bgcolor="#BAAFAF" scope="col"><?php //echo "<h5 align='center'"."<br>".$sub_code210."<br> ".$teacher_id210."<br> ".$room_No210; ?></th>  <?php }   
            ...
            ?>
			  ...
			  <?php if ($lab_409=='l') {?>	
			   <th  bgcolor="#BAAFAF"scope="col"><?php// echo "<h5 align='center'"."<br>".$sub_code208."<br> ".$teacher_id208."<br> ".$room_No208; ?></th>
              <th  bgcolor="#BAAFAF"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code409."<br> ".$teacher_id409."<br> ".$room_No409; ?></th>
              <th bgcolor="#BAAFAF" scope="col"><?php //echo "<h5 align='center'"."<br>".$sub_code210."<br> ".$teacher_id210."<br> ".$room_No210; ?></th>  <?php }   
              ...
              while ( $row = mysqli_fetch_array($result1))
              {
                ...
                elseif ($row['ctime']=='14:00-15:00'&& $row['lab']=='l') {
				  ...
				  elseif ($row['ctime']=='14:00-15:00'&& $row['lab']=='c') {
				  $lab_514='c';	
                  $sub_code514 = $row['sub_code'];
                  $teacher_id514 = $row['teacher_id'];
                  $room_No514 = 'Room-'.$row['room_no'];
            ...
            ?>
			  ...
			  <?php if ($lab_514=='l') {?>	
			   <th  bgcolor="#BAAFAF"scope="col"><?php// echo "<h5 align='center'"."<br>".$sub_code208."<br> ".$teacher_id208."<br> ".$room_No208; ?></th>
              <th  bgcolor="#BAAFAF"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code515."<br> ".$teacher_id515."<br> ".$room_No515; ?></th>
              <th bgcolor="#BAAFAF" scope="col"><?php //echo "<h5 align='center'"."<br>".$sub_code210."<br> ".$teacher_id210."<br> ".$room_No210; ?></th>  <?php }   
            ...
            ?>
			  	  ...
			  	  <?php if ($lab_609=='l') {?>	
			   <th  bgcolor="#BAAFAF"scope="col"><?php// echo "<h5 align='center'"."<br>".$sub_code208."<br> ".$teacher_id208."<br> ".$room_No208; ?></th>
              <th  bgcolor="#BAAFAF"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code609."<br> ".$teacher_id609."<br> ".$room_No609; ?></th>
              <th bgcolor="#BAAFAF" scope="col"><?php //echo "<h5 align='center'"."<br>".$sub_code210."<br> ".$teacher_id210."<br> ".$room_No210; ?></th>  <?php }   
...
<tr align="center">
<td bgcolor="#8C8383" style="color:#8C8383">
...
<tr align="center">
<td colspan="7" bgcolor="#934646" style="color:#FFFFFF"><strong><?php echo $monthNames[$cMonth-1].' '.$cYear; ?></strong></td>
</tr>
<tr>
