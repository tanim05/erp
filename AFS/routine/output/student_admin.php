...
//     $result=mysqli_query($connect, $query);
  ...
  //       }
	...
	?>
			...
			<div class="col-sm-3">
				<h3 align='center'> <b><font color='3583B0'>Routine For <span><?php echo $Semester;?> Semester</span></b></font></h3>
			</div>
       ...
       while ( $row = mysqli_fetch_array($result1))
        {
            ...
            ?>
             ...
             <?php if ($lab_214=='l') {?>	  
             <th bgcolor="#909497" scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code214."<br> ".$teacher_id214."<br> ".$room_No214; ?></th>
              <th  bgcolor="#909497"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code215."<br> ".$teacher_id215."<br> ".$room_No215; ?></th>
              <th  bgcolor="#909497"scope="col"><?php echo "<h5 align='center'"."<br>".$sub_code216."<br> ".$teacher_id216."<br> ".$room_No216; ?></th><?php }   
