...
<?php
$queryForGradeId = "select * from tbl_grade";
$statementForGradeId = $connect->prepare($queryForGradeId);
$statementForGradeId->execute();
$resultForGradeId = $statementForGradeId->fetchAll();
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Intake-Batch<span class="text-danger">*</span></label>
              <!-- Example single danger button -->
              <div class="col-md-8">
                <select name="grade_id" id="grade_id" class="form-control">
                    <option value="">Select a Intake Batch</option>
                  <?php 
                    foreach($resultForGradeId as $row){
                    ?>
          ...
          <div class="form-group" id="student_details">
            <div class="table-responsive">
              <table class="table table-striped table-bordered" id="updatedTable">
                </table>
            </div>
          </div>
          <?php
...
$('#grade_id').change(function(){
    ...
    alert(gradeId);
    $.ajax({
      url:"searchStudentWithGradeId.php",
      method:"POST",
