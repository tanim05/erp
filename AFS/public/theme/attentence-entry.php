            ...
            <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item">
                            <a href="http://ibaseip.csl-erp.com/admin/course/index.php" class="nav-link"><i
                        ...
                        <li class="nav-item">
                            <a href="http://ibaseip.csl-erp.com/admin/subject/index.php" class="nav-link"><i
                                    class="flaticon-open-book"></i><span>Subject</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="http://ibaseip.csl-erp.com/admin/schedule/index.php" class="nav-link"><i
                                    class="flaticon-calendar"></i><span>Class
                                    Routine</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="http://ibaseip.csl-erp.com/admin/class/index.php" class="nav-link"><i
                        ...
                        <li class="nav-item">
                            <a href="http://ibaseip.csl-erp.com/admin/percent/index.php" class="nav-link"><i
                                    class="flaticon-shopping-list"></i><span>Grade Percentage</span></a>
                        </li>
                        <li class="nav-item ">
                            <a href="http://ibaseip.csl-erp.com/admin/exam1/index.php" class="nav-link"><i
                        ...
                        <li class="nav-item">
                            <a href="http://ibaseip.csl-erp.com/admin/user/index.php" class="nav-link"><i
